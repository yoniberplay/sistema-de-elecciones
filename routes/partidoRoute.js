...
router.get(
  "/edit-partido/:partidoId",
  admintauth,
  PartidoController.GetEditPartido
);
...
router.post(
  "/confirm-delete-partido",
  admintauth,
  PartidoController.PostConfirmDeletePartido
);

router.post(
  "/activar-partido",
  admintauth,
  PartidoController.PostActivarPartido
);
